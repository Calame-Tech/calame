...
// ---------------------------------------------------------------------------
// isPrivateIPv4 — TEST-NET-1 (192.0.2.0/24, RFC 5737 documentation range)
// ---------------------------------------------------------------------------

describe('isPrivateIPv4 TEST-NET-1', () => {
  it('returns false for 192.0.2.1 (not currently blocked)', () => {
    expect(isPrivateIPv4('192.0.2.1')).toBe(false);
  });
});
