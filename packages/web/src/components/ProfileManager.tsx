...
export default function ProfileManager({
  ...
  return (
    <div className="px-4 py-3 border-b border-white/5 bg-gray-900/30">
      <div className="flex items-center gap-2 flex-wrap">
        <span className="eyebrow mr-1">Profiles</span>
            ...
            {editingIndex === i ? (
              ...
              >
                <input
                  ...
                  autoFocus
                  className="input-editorial text-xs w-24"
        ...
        {creating ? (
          ...
          >
            <input
              ...
              autoFocus
              className="input-editorial text-xs w-28"
              onBlur={() => {
        ...
        <div className="flex items-center gap-1.5">
          <button
            onClick={onSave}
            className="flex items-center gap-1 px-2.5 py-1.5 text-xs text-gray-400 hover:text-gray-200 border border-white/10 hover:border-white/20 rounded-lg transition-all duration-200"
          >
            <svg className="w-3.5 h-3.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              <path
                strokeLinecap="round"
          ...
          <HelpTip
            content="Save all profiles to calame-profiles.json."
            position="bottom"
            size="xs"
          />
        </div>
        <div className="flex items-center gap-1.5">
          ...
          <HelpTip
            content="Load profiles from calame-profiles.json (replaces the current configuration)."
            position="bottom"
            size="xs"
          />
        </div>
